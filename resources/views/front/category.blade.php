...
@section('content')
    ...
    <header
        class="w-full pt-[74px] pb-[34px] bg-[url('{{ asset('images/backgrounds/heroimages.png') }}')] bg-cover bg-no-rep% bg-center relative z-0">
                ...
                <form action="{{ route('front.search') }}" method="GET"
                    ...
                    <div class="relative text-left">
                        ...
                        <input type="reset" id="resetButton" name="keyword"
                            class="close-button w-[38px] h-[38px] flex shrink-0 bg-[url('{{ asset('images/icons/close.svg') }}')] hover:bg-[url('{{ asset('images/icons/close-white.svg') }}')] transition-all duration-300 appearance-none transform -translate-x-1/2 -translate-y-1/2 absolute top-1/2 -right-5"
                            value="">
                    </div>
                </form>
            </div>
